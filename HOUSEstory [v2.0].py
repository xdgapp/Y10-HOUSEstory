...
def start():
	global easy, showered, sisterKilled, blocked, mumBlinded, rugPulled, trapdoorLocked, crawlspaceDark, dadBlinded, dadBlinded, frontDoorLocked, flashlight, key, keys, skull, sistersBody
	showered = 0							#setting conditions
	sisterKilled = 0
	blocked = 1
	mumBlinded = 0
	rugPulled = 0
	...
	dadBlinded = 0
	frontDoorLocked = 1
	flashlight = 0							#resets inventory and items
	key = 0
	keys = 0
	skull = 0
	sistersBody = 0
	...
	print("Commands will only register if the input line contains \">\", else just press [enter] to continue.")
...
def sistersRoom():			#sister is still alive, cant do much in this state
...
def blockedParentsRoom():
	global userInput, easy, blocked, mumBlinded
